...
func connect() error {
	database, err := sql.Open("sqlite3", config.Config.Database.Path)
	if err != nil {
		return err
	}
	DB = database
...
func InitDB() {
	...
	// Read the SQL file
	sqlBytes, err := os.ReadFile(config.Config.Database.Schema)
	if err != nil {
		log.Fatal(err)
	}
...
func CreateFakeData() {
	// Create users
	users := []models.User{
		{Username: "alice", Email: "alice@example.com", Password: "alice", FirstName: "alice", LastName: "alice", Gender: "male", Age: 26},
		{Username: "bob", Email: "bob@example.com", Password: "bob", FirstName: "bob", LastName: "bob", Gender: "male", Age: 26},
		{Username: "charlie", Email: "charlie@example.com", Password: "charlie", FirstName: "charlie", LastName: "charlie", Gender: "male", Age: 26},
		{Username: "david", Email: "david@example.com", Password: "david", FirstName: "david", LastName: "david", Gender: "male", Age: 26},
		{Username: "eve", Email: "eve@example.com", Password: "eve", FirstName: "eve", LastName: "eve", Gender: "male", Age: 26},
	}
